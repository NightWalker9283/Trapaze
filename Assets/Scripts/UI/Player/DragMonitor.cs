...
public sealed class DragMonitor : MonoBehaviour
{
    ...
    static public bool Tap { get; protected set; }
    static public bool Drag { get; protected set; }
    static public Vector3 TapPosition { get; protected set; }
    static public Vector3 DragPosition { get; protected set; }
